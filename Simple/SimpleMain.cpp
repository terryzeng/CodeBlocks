...
BEGIN_EVENT_TABLE(SimpleDialog, wxDialog)
    EVT_CLOSE(SimpleDialog::OnClose)
    EVT_BUTTON(idBtnQuit, SimpleDialog::OnQuit)
    EVT_BUTTON(idBtnAbout, SimpleDialog::OnAbout)
END_EVENT_TABLE()

SimpleDialog::SimpleDialog(wxDialog *dlg, const wxString &title)
...
void SimpleDialog::OnClose(wxCloseEvent &event)
{
    Destroy();
}
...
void SimpleDialog::OnAbout(wxCommandEvent &event)
{
